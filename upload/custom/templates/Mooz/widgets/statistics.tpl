    ...
    <div class="card-body" style="padding-top: 1px;">
        ...
        {if isset($FORUM_STATISTICS)}
          <li>
            ...
            <div class="float-right text-muted"><b>{$TOTAL_THREADS_VALUE}</b></div>
          </li>
          <li>
            <span class="text">{$TOTAL_POSTS}</span>
            <div class="float-right text-muted"><b>{$TOTAL_POSTS_VALUE}</b></div>
          </li>
        {/if}
        <li>
          <span class="text">{$USERS_REGISTERED}</span>
          <div class="float-right text-muted"><b>{$USERS_REGISTERED_VALUE}</b></div>
        </li>
        <li>
