    ...
    function loadEmojione(options) {
        ...
        if (!cdn.isLoading) {
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                ...
                $.ajax({
                    url: siteURL + "core/assets/plugins/emoji/js/emojione.min.js",
                    dataType: "script",
                    cache: true,
                    success: function () {
                        ...
                        if (emojioneSupportMode > 4) {
                            ...
                            sprite = siteURL + "core/assets/plugins/emoji/css/emojione.sprites.css";
                        } else {
        ...
        emojioneReady(function() {
            ...
            if (options.useInternalCDN) {
                ...
                emojione.imagePathSVGSprites = siteURL + "core/assets/plugins/emoji/sprites/emojione.sprites.svg";
